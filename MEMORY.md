...
- Google Analytics `gtag` with measurement ID `G-0PB5VDR3F9` is wired in the root app layout only for the exact production host `interlex.kz`, using `beforeInteractive`
